...
require_literal "GPDMA1.REQUEST_GPDMACH0=GPDMA1_REQUEST_UCPD1_RX" "$ioc"
require_literal "GPDMA1.DIRECTION_GPDMACH0=DMA_PERIPH_TO_MEMORY" "$ioc"
require_literal "GPDMA1.DESTINC_GPDMACH0=DMA_DINC_INCREMENTED" "$ioc"
require_literal "GPDMA1.REQUEST_GPDMACH1=GPDMA1_REQUEST_UCPD1_TX" "$ioc"
require_literal "GPDMA1.DIRECTION_GPDMACH1=DMA_MEMORY_TO_PERIPH" "$ioc"
require_literal "GPDMA1.SRCINC_GPDMACH1=DMA_SINC_INCREMENTED" "$ioc"
require_literal "EXTMEM_MANAGER.RefParam_LRUN_SRC_size=0x00080000" "$ioc"
